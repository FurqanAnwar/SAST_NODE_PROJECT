...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"loginForm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePassword = exports.resetPassword = exports.forgotPassword = exports.logout = exports.signup = exports.login = void 0;
...
console.log("Hello from the client side"); // Get elements
...
if (loginForm) {
  ...
  loginForm.addEventListener('submit', e => {
    ...
    (0, _loginForm.login)(email, password);
  });
}
...
if (signUpForm) {
  signUpForm.addEventListener('submit', e => {
    ...
    (0, _loginForm.signup)(userName, email, password, confirmPassword);
  });
}

if (btnNavBar) {
  btnNavBar.addEventListener("click", _loginForm.logout);
}

if (btnLogOut) {
  console.log(btnLogOut);
  btnLogOut.addEventListener("click", _loginForm.logout);
}
...
if (btnForgotPassword) {
  btnForgotPassword.addEventListener("click", e => {
    ...
    (0, _loginForm.forgotPassword)(email);
  });
}
...
if (resetPasswordBtn) {
  resetPasswordBtn.addEventListener("click", e => {
    ...
    (0, _loginForm.resetPassword)(newPassword, confirmPassword, token);
  });
}
...
if (updatePasswordBtn) {
  updatePasswordBtn.addEventListener("click", e => {
    ...
    const confirmPassword = document.getElementById("updatePassword-Confirm").value; // console.table({currentPassword,newPassword,confirmPassword})

    (0, _loginForm.updatePassword)(currentPassword, newPassword, confirmPassword);
  });
}

if (submitBtnArr) {
  console.log("Hello from questions view");
  let questionNo = window.location.pathname.slice(11); //make an axios get request
  ...
  for (let btn of submitBtnArr) {
    ...
    btn.addEventListener("click", e => {
      ...
      const childs = grandParentNode.childNodes; // console.log(targetNode, parentNode, grandParentNode);

      console.log(childs);
      const question = childs[1];
      const ans = childs[2];
      console.log(question, ans); // console.log("WTF",ans,question);
      ...
      for (let val of answers) {
        ...
        if (question.textContent === val.question && ans.value === val.answer) {
          ...
          alert("You gussed it right 😃"); // store ans along with ans and update user document

          ans.setAttribute("disabled", "");
          targetNode.setAttribute("disabled", ""); // let obj = {
...
},{"axios":"../../node_modules/axios/index.js","./loginForm":"loginForm.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
